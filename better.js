...
{   
    if( this.notification )
    {
        ...
        {
            if( this.notification.header.processName ) this.facade.nextCommand( this.notification );
        }
    }
...
{
	if( this._cronStack[labelOrName]) ( this._cronStack[labelOrName]).start();
};
...
AbstractFacade.prototype.flushStack = function()
{
    ...
    if( this.isStackMode ) 
    {
        ...
        if( this.stack.length > 0 ) setTimeout( this.flushStack, 300 );
    }
};
